                  ...
                  <div className="cmc">
                      <div className="cmt">
                        ...
                        <div className="info">
                          ...
                          <p>Векторные произведения искусства создаются на основе векторной графики, которая представляет собой изображения, нарисованные с помощью математических формул.</p>
                        </div>
                        </div>
                        <div className="card">
                        <div className="info">
                          <h2>BS-42  '3D models and animation'</h2>
                          <p>С нами вы научитесь создавать модели различных предметов в трехмерном пространстве и их последующим оживлении на экране.</p>
                        </div>
                        </div>
                      </div>
